...
@section('title', 'Laporan Pembelian Member')
        ...
        <div class="table-responsive">
            ...
            <div class="card-footer">
                <div class="text-right">
                    <a href="{{ route('pembelian', ['dari' => request()->input('dari'), 'sampai' => request()->input('sampai')]) }}" class="btn btn-danger btn-sm">
...
<script>
    $(function() {
        ...
        $.ajax({
            url: `/api/reports/users?dari=${dari}&sampai=${sampai}`,
            headers: {
                ...
                data.map(function(val, index) {
                    row += `
                        <tr>
                            ...
                            <td>${val.email}</td>
                            <td>${val.total_jumlah}</td>
                            <td>${rupiah(val.total_total)}</td>
                        </tr>
                        `;
                });
                $('tbody').append(row)
