    ...
    <div class="flex py-10 md:py-20 px-5 md:px-32 bg-gray-200 min-h-screen">
        <div class="flex shadow w-full flex-col-reverse lg:flex-row">
            <div class="w-full lg:w-1/2 bg-white p-10 px-5 md:px-20">
                ...
                <form action="/register_store" class="mt-10" method="POST">
                    @csrf
                    <div class="my-3">
                        <label class="font-semibold" for="nama_store">Nama store</label>
                        <input required type="text" placeholder="Nama store" name="nama_store" id="nama_store"
                    ...
                    <div class="my-3">
                        ...
                        <textarea required placeholder="Alamat" name="alamat" id="alamat"
                        class="block border-2 rounded-lg mt-2 py-2 px-5 w-full resize-none"></textarea>
                    </div>
                    <div class="my-3">
                        <label class="font-semibold" for="social_media">Social Media</label>
                        <input required type="text" placeholder="Social Media Link" name="social_media" id="social_media"
                            class="block border-2 rounded-full mt-2 py-2 px-5 w-full">
                    </div>
                    <div class="my-3">
                        <label class="font-semibold" for="online_store">Online Store</label>
                        <input required type="text" placeholder="Online Store Link" name="online_store" id="online_store"
                            class="block border-2 rounded-full mt-2 py-2 px-5 w-full">
                    </div>
                    <div class="my-3">
                ...
                <span>Have an account? <a href="/login_store" class="text-blue-400 hover:text-blue-600">Login
                        here.</a></span>
            </div>
